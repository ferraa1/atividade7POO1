...
public class Main {
	...
	public static void main(String[] args) {
		...
		// valores para geração de médicos e pacientes aleatórios
		Especialidade[] especialidades = { new Especialidade("Cirurgião geral"), new Especialidade("Ortopedista"),
				new Especialidade("Pediatra"), new Especialidade("Cardiologista"),
				new Especialidade("Oftalmologista") };
		String[] nomes = { "João", "Roberto", "Marcos", "Felipe", "Carlos", "Renato", "Ana", "Rebeca", "Raquel",
				"Daniela", "Marcela", "Amanda" };

		// geração de 3 médicos aleatórios
		...
		// geração de 20 pacientes aleatórios
		for (int i = 0; i < 20; i++) {
			lista.addLista(
		...
		do {
			...
			System.out.println("5 = Mostrar histórico de um médico");
			...
			case 2:
				...
				int mes;
				do {
					System.out.println("Informe o mês de nascimento do paciente:");
					mes = sc.nextInt();
				} while (mes < 1 || mes > 12);
				int dia;
				do {
				...
				int resposta;
				do {
					System.out.println("Os sintomas do paciente são agudos/severos? 1 = Sim, 0 = Não:");
					resposta = sc.nextInt();
				...
				if (resposta == 1)
					...
					respostas[0] = false;
				do {
					System.out.println("O paciente está perdendo sangue? 1 = Sim, 0 = Não:");
					resposta = sc.nextInt();
				} while (resposta != 1 && resposta != 0);
				if (resposta == 1)
					respostas[1] = true;
					...
					respostas[1] = false;
				do {
					System.out.println("O paciente possui anemia? 1 = Sim, 0 = Não:");
					resposta = sc.nextInt();
				} while (resposta != 1 && resposta != 0);
				if (resposta == 1)
					respostas[2] = true;
					...
					respostas[2] = false;
				do {
					System.out.println("O paciente possui diabetes? 1 = Sim, 0 = Não:");
					resposta = sc.nextInt();
				} while (resposta != 1 && resposta != 0);
				if (resposta == 1)
					respostas[3] = true;
			...
			case 3:
				// atender paciente
				do {
					System.out.println("Informe o nome do médico que vai atender o paciente:");
					nome = sc.next();
				} while (nome == null);
				med = null;
